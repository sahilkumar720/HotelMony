...
const HotelReg = () => {
  return (
    <div className='fixed top-0 bottom-0 left-0 right-0 z-100 flex items-center justify-center bg-black/70'>
        ...
        <form className='flex bg-white rounded-xl max-w-4xl mx-md:mx-2'> 
            <img src={assets.regImage}
            className='w-1/2 rounded-xl hidden md:block' alt="reg-image" />
...
{/* address...  */}
        ...
        <button className='bg-indigo-500 hover:bg-indigo-700 transition-all text-white m-auto px-6 py-2 rounded cursor-pointer mt-6'>
            Register
        </button>

  ...
  return (
    <div className='py-28 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      {bookings.map((booking)=>(
        <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-gray-300 py-6 first:border-t'>

            {/* hotel details   */}


            <div className='flex flex-col md:flex-row'>
                <img src={booking.room.images[0]} alt="hotel-img" className='min-md:w-44 rounded shadow objext-cover' />
    ...
    <span className='font-inter text-sm'> ({booking.room.roomType})</span>
            ...
            <div className='flex flex-col items-start justify-center pt-3'>
                ...
                {!booking.isPaid && (
                    <button className='px-4 py-1.5 mt-4 text-xs border border-gray-400 rounded-full hover:bg-gray-100 transition-all cursor-pointer'>Pay Now</button>
                )}
